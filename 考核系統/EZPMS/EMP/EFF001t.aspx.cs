...
public partial class EFF001t : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            note.Text = DataClass.getNote("EMP.EFF001t.aspx");
        }
    }
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (attrow != null)
        {
            ...
            if (baserow != null)
            {
                ...
                HyperLink1.NavigateUrl = "~/EMP/EFF002t.aspx";
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
          ...
          if (baserow != null)
          {
              ...
              effsnum.Text = Convert.ToString(Math.Round(row.totnum, 1)) ;
              if ((int)row.totnum == 0)
              {
                  effs.Text = "未評等";
              }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (Session["EFFSInfo"] != null)
        {
            Response.Redirect("EFF002t.aspx");
        ...
        try
        {
            ...
            if (attrow != null)
            {
                ...
                if (e.CommandName.Trim().Equals("openEffs"))
                {
                    ...
                    CS.Scrip(UpdatePanel1, "EFF002t.aspx");

                }
                else if (e.CommandName.Trim().Equals("openSelfEffs"))
                {
                    CS.Scrip(UpdatePanel1, "../Mang/SelfEffs.aspx");
                }
