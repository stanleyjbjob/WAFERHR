<%@ Page Language="C#"  AutoEventWireup="true"
    CodeFile="PrintEffs.aspx.cs" Inherits="PrintEffs" Title="合晶科技績效考核系統（Web版）v1.0" ValidateRequest="false"  StylesheetTheme ="JBRPrint_theme" %>
...
<body>
    ...
    <fieldset>
                                ...
                                <asp:TemplateField HeaderText="比重" SortExpression="effsNum">
                                    ...
                                    <FooterTemplate>
                                        <asp:Label ID="g5_f_rate" runat="server" Font-Bold="True" ForeColor="Blue" Height="16px"
                                         Font-Size="Small"    ></asp:Label><asp:Label ID="Label5" runat="server"
                                                Font-Bold="True" ForeColor="Blue" Text="%" Font-Size="Small" ></asp:Label>
                                    </FooterTemplate>
                                </asp:TemplateField>
        ...
        </asp:DataList><asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:syanghrConnectionString %>"
    ...
    <fieldset>
        <legend>3.績效面談</legend>
               ...
               <FIELDSET><LEGEND>4.訓練需求</LEGEND><asp:ObjectDataSource id="SelfEduObjectDataSource" runat="server" UpdateMethod="Update" TypeName="EFFDSTableAdapters.EFFS_SELFEDUTableAdapter" SelectMethod="GetDataByEduCateItemID" OldValuesParameterFormatString="original_{0}" InsertMethod="Insert" DeleteMethod="Delete">
                    <InsertParameters>
                        <asp:Parameter Name="yy" Type="Int32"  />
                        <asp:Parameter Name="seq" Type="Int32"  />
                        <asp:Parameter Name="nobr" Type="String"  />
                ...
                </asp:ObjectDataSource><FIELDSET><LEGEND>其他評核主管意見：</LEGEND><asp:GridView id="GridView31" runat="server" DataSourceID="ObjectDataSource21" DataKeyNames="AuotKey" AutoGenerateColumns="False">
                        <Columns>
