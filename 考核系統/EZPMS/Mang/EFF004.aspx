<%@ Page Language="C#" MasterPageFile="~/JBRF_MasterPage.master" AutoEventWireup="true"
    CodeFile="EFF004.aspx.cs" Inherits="Mang_EFF004" Title="合晶科技績效考核系統（Web版）v1.0" ValidateRequest="false" %>

<%@ Register Src="EFF002.ascx" TagName="EFF002" TagPrefix="uc3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    &nbsp;
    <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="5" BackColor="#EFF3FB" BorderColor="#B5C7DE"
        ...
        <WizardSteps>
            <asp:WizardStep runat="server" Title="1.工作目標設定 MBO">
                <asp:Button ID="Button3" runat="server" CommandArgument="0" OnClick="Button3_Click"
                    Text="暫時存檔" />
                                ...
                                <asp:TemplateField HeaderText="員工自評">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="LB_Apprid" runat="server" Text='<%# Bind("AutoKey") %>' Visible="False"></asp:Label>
                                         <asp:DropDownList ID="ddl_num" runat="server" Enabled="False">
                ...
                <asp:Button ID="Button41" runat="server" CommandArgument="0" OnClick="Button3_Click"
                    Text="暫時存檔" />
                <fieldset>
                    <legend>說明</legend>
            ...
            <asp:WizardStep runat="server" Title="2.行為職能發展期望與評核">
                <asp:MultiView ID="MultiView2" runat="server" ActiveViewIndex="0">
                    <asp:View ID="View3" runat="server">
                        <asp:Button ID="Button4" runat="server" CommandArgument="2" OnClick="Button3_Click"
                            Text="暫時存檔" />
                        <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" DataSourceID="dataViewDs"
                            meta:resourcekey="GridView5Resource1" OnRowDataBound="GridView5_RowDataBound" OnDataBound="GridView5_DataBound" Visible="False">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="比重" SortExpression="effsNum">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="_rate" runat="server" Text='<%# Bind("rate","{0:00.00}") %>' ForeColor="Blue"></asp:Label><asp:Label
                                ...
                                <asp:TemplateField HeaderText="主管評分">
                                    <ItemTemplate>
                                        <asp:TextBox ID="mangnum" Visible ="false" runat="server" Width="40px" Font-Bold="True" ForeColor="Red"></asp:TextBox>
                                         <asp:DropDownList ID="ddl_mangnum" runat="server">
                                                            <asp:ListItem Value=" ">※請選擇※ </asp:ListItem>
                                                            <asp:ListItem Value="4">超過標準</asp:ListItem>
                                                            <asp:ListItem Value="3">符合標準</asp:ListItem>
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" width="90%">
                                                <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" DataSourceID="dataViewDs"
                            meta:resourcekey="GridView5Resource1" OnRowDataBound="GridView5_RowDataBound" OnDataBound="GridView5_DataBound">
                                                    <Columns>
                                                        <asp:BoundField DataField="effsID" meta:resourcekey="BoundFieldResource17" SortExpression="effsID"
                                    Visible="False" />
                                                        <asp:BoundField DataField="effsName" HeaderText="考核細目" meta:resourcekey="BoundFieldResource18"
                                    SortExpression="effsName">
                                                        ...
                                                        <asp:TemplateField Visible="False">
                                                            <ItemTemplate>
                                                                <asp:Label ID="nummang1" runat="server"></asp:Label>
                                                                  <asp:Label ID="Label14" runat="server" ForeColor="red" Text="xx"></asp:Label>
                                                            </ItemTemplate>
                                                            <FooterStyle Font-Bold="True" Font-Size="X-Small" ForeColor="Red" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField Visible="False">
                        ...
                        <asp:Button ID="Button2" runat="server" CommandArgument="2" OnClick="Button3_Click"
                            Text="暫時存檔" />
                    </asp:View>
                </asp:MultiView>
            ...
            <asp:WizardStep runat="server" Title="3.員工自評項目">
                <asp:MultiView ID="MultiView3" runat="server" ActiveViewIndex="0">
                    <asp:View ID="View5" runat="server">
                        &nbsp;<asp:Button ID="Button311" runat="server" CommandArgument="3" OnClick="Button3_Click"
                            Text="暫時存檔" />
...
ORDER BY  EFFS_TEMPLETINTERVIEW.[order]">
                        ...
                        <table border="1" cellpadding="0" cellspacing="0" class="MsoNormalTable" style="border-right: medium none;
                            ...
                            <tr style="mso-yfti-irow: 0; mso-yfti-firstrow: yes">
                                ...
                                <td style="border-right: windowtext 1pt solid; padding-right: 1.4pt; border-top: windowtext 1.5pt solid;
                                    ...
                                    mso-border-right-alt: .5pt; mso-border-color-alt: windowtext; mso-border-style-alt: solid"
                                    valign="middle" width="60" align="center">
                                    <asp:Label ID="Label13" runat="server" Text="評等 " Visible="False"></asp:Label></td>
                            </tr>
                            <tr style="mso-yfti-irow: 1; page-break-inside: avoid">
                                <td style="border-right: windowtext 1pt solid; padding-right: 1.4pt; border-top: #ece9d8;
                                    ...
                                    <asp:Label ID="Label7" runat="server" Text="工作目標評估"></asp:Label></td>
                                <td style="border-right: windowtext 1pt solid; padding-right: 1.4pt; border-top: #ece9d8;
                                    padding-left: 1.4pt; padding-bottom: 0cm; border-left: #ece9d8; width: 54pt;
   ...
   <asp:Label id="Label4" runat="server" Font-Size="Small" ForeColor="Red" Text='<%# Eval("effs") %>' Font-Bold="True" Visible="False"></asp:Label>
                                </td>
                            </tr>
                            <tr style="mso-yfti-irow: 2; page-break-inside: avoid; mso-yfti-lastrow: yes">
                                <td style="border-right: windowtext 1pt solid; padding-right: 1.4pt; border-top: #ece9d8;
                                    ...
                                    mso-border-right-alt: .5pt; mso-border-color-alt: windowtext; mso-border-style-alt: solid"
                                    valign="top" width="156">
                                    <asp:Label ID="Label8" runat="server" Text="行為職能發展期望與評核"></asp:Label></td>
                                <td style="border-right: windowtext 1pt solid; padding-right: 1.4pt; border-top: #ece9d8;
                                    padding-left: 1.4pt; padding-bottom: 0cm; border-left: #ece9d8; width: 54pt;
                    ...
                    <ItemTemplate>
                        <table border="1" cellpadding="0" cellspacing="0" class="MsoNormalTable" style="border-right: medium none;
                            ...
                            <tr style="mso-yfti-irow: 0; mso-yfti-firstrow: yes">
                                ...
                                <td style="border-right: windowtext 1pt solid; padding-right: 1.4pt; border-top: windowtext 1.5pt solid;
                                    padding-left: 1.4pt; padding-bottom: 0cm; border-left: windowtext 1.5pt solid; padding-top: 0cm; border-bottom: windowtext 1pt solid; background-color: transparent;
                                    mso-border-top-alt: 1.5pt; mso-border-left-alt: 1.5pt; mso-border-bottom-alt: .5pt;
                                    mso-border-right-alt: .5pt; mso-border-color-alt: windowtext; mso-border-style-alt: solid"
                                    valign="middle" align="left" colspan="6" rowspan="3">
            ...
            <asp:Button
                    ID="FinishButton" runat="server" BackColor="Transparent" BorderColor="#507CD1" BorderStyle="Solid"
                    BorderWidth="1px" CommandName="MoveComplete" Font-Names="Verdana" Font-Size="Large"
                    ForeColor="White" Text="本期考核資料評核完成，並發MAIL通知給主管" OnClientClick="return confirm('確定本期核資料評核完成，傳送後就不可修改？');" OnClick="FinishButton_Click1" Height="63px" Width="571px" />
        ...
        <StepNavigationTemplate>
            <asp:Button ID="StepPreviousButton" runat="server" BackColor="White" BorderColor="#507CD1"
                ...
                Font-Names="Verdana" Font-Size="0.8em" ForeColor="White" Text="上一頁" Visible="False" />&nbsp;<asp:Button
                    ...
                    ForeColor="White" Text="儲存資料並執行下一頁" Visible="False" />
        </StepNavigationTemplate>
