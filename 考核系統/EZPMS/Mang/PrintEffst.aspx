            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="主管評分">
                    ...
                    <ItemTemplate>
                        ...
                        <asp:DropDownList ID="ddl_mangnum" runat="server" Enabled="False" Visible="False">
                            <asp:ListItem Value=" ">※請選擇※ </asp:ListItem>
                            <asp:ListItem Value="4">超過標準</asp:ListItem>
                            <asp:ListItem Value="3">符合標準</asp:ListItem>
                            <asp:ListItem Value="2">需改進</asp:ListItem>
                        ...
                        <asp:Label ID="lb_mnum" runat="server" Font-Bold="True"></asp:Label>
                    </ItemTemplate>
                    <FooterStyle Font-Bold="True" Font-Size="X-Small" ForeColor="Red" />
                        ...
                        <tr>
                            ...
                            <td colspan="3" width="90%">
                                <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" DataSourceID="dataViewDs"
                                    meta:resourcekey="GridView5Resource1" OnDataBound="GridView5_DataBound" OnRowDataBound="GridView5_RowDataBound" SkinID="gridviewprint" Width="100%">
                                    <Columns>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td width="20%">
                                            對低於標準之項目請舉實例說明</td>
                                        <td width="30%">
                                            <asp:TextBox ID="o1" runat="server" Rows="3" TextMode="MultiLine" Width="100%" Visible="False"></asp:TextBox>
                                            <asp:Label ID="lb_o1" runat="server"></asp:Label></td>
                                        <td width="20%">
                                            對超過標準之項目請舉例說明</td>
                                        <td width="30%">
                                            <asp:TextBox ID="o2" runat="server" Rows="3" TextMode="MultiLine" Width="100%" Visible="False"></asp:TextBox>
                                            <asp:Label ID="lb_o2" runat="server"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            需改進方向</td>
                                        <td colspan="3">
                                            <asp:TextBox ID="o3" runat="server" Rows="3" TextMode="MultiLine" Width="100%" Visible="False"></asp:TextBox>
                                            <asp:Label ID="lb_o3" runat="server"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>
                                        </td>
    ...
    <fieldset id="AP03" runat="server">
        <legend>2.績效面談</legend>
               ...
               <FIELDSET id="AP04" runat="server" visible="false"><LEGEND>4.訓練需求</LEGEND><asp:ObjectDataSource id="SelfEduObjectDataSource" runat="server" UpdateMethod="Update" TypeName="EFFDSTableAdapters.EFFS_SELFEDUTableAdapter" SelectMethod="GetDataByEduCateItemID" OldValuesParameterFormatString="original_{0}" InsertMethod="Insert" DeleteMethod="Delete">
                ...
                </asp:ObjectDataSource> <asp:GridView id="GridView2" runat="server" DataSourceID="SelectEduObjectDataSource" DataKeyNames="AutoKey" AutoGenerateColumns="False" SkinID="gridviewprint">
                    <Columns>
                        <asp:BoundField DataField="AutoKey" HeaderText="AutoKey" ReadOnly="True" SortExpression="AutoKey"
