<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EFF002t.aspx.cs" Inherits="Mang_EFF002t" ValidateRequest="false" %>
...
<fieldset>
        ...
        <asp:View ID="View2" runat="server">
            ...
            <fieldset>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                    DataKeyNames="autoKey" DataSourceID="ObjectDataSource1" OnRowDataBound="GridView1_RowDataBound" Font-Size="Larger"
    ...
    <asp:Label ID="appoint" runat="server" Text="False" Visible="False"></asp:Label>
    <fieldset>
        <legend>說明</legend>
