<%@ Page Language="C#" MasterPageFile="~/JBR_MasterPage.master" AutoEventWireup="true"
    CodeFile="EFF003t.aspx.cs" Inherits="EFF003t" Title="合晶科技績效考核系統（Web版）v1.0" ValidateRequest="false" %>
                        ...
                        <ContentTemplate>
                            <fieldset>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" OnCheckedChanged="CheckBox1_CheckedChanged"
                                                Text="檢視評核傳送時間" />
                                <asp:GridView ID="GridView8" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridView8_RowDataBound" Visible="False">
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                            ...
                                            <asp:Label ID="to_effs_f" runat="server" Text="0" Visible="False"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 10%">
                                            <asp:Label ID="Label3" runat="server" Text="排序："></asp:Label></td>
                                        <td colspan="2">
                                ...
                                <asp:GridView ID="GridView7" runat="server"  AutoGenerateColumns="False"
                                    ...
                                    ShowFooter="True" OnDataBound="GridView7_DataBound">
                                    <Columns>
                                        <asp:TemplateField ShowHeader="False">
                                            <ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="effsgroupname" HeaderText="群組" SortExpression="effsgroupname"
                                            Visible="False" />
                                        <asp:TemplateField HeaderText="自評績效">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="自評態度">
                                            <ItemTemplate>
                            ...
                            <fieldset>
                                ...
                                <asp:GridView ID="GridView5" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ShowHeader="False">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/MANG/EFF004t.aspx?yy=" + Eval("yy") + "&seq=" + Eval("seq") + "&nobr=" + Eval("nobr")+"&tempID="+Eval("templetID")+"&Appoint=True" %>'
                                                    Target="_blank">績效考核表</asp:HyperLink>
                                                    <br />
                                                      <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# "~/MANG/PrintEffst.aspx?yy=" + Eval("yy") + "&seq=" + Eval("seq") + "&nobr=" + Eval("nobr")+"&tempID="+Eval("templetID")+"&Appoint=True" %>'
                                                    Target="_blank">列印</asp:HyperLink>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="effbaseID" HeaderText="effbaseID" ReadOnly="True" SortExpression="effbaseID"
