    ...
    
{
            ...
            switch (CurrentStepIndex)
            {
                ...
                case 2:
                    ...
                    for (int i = 0; i < DataList2.Items.Count; i++)
                    {
                        ...
                        Label lb_o1 = DataList2.Items[i].FindControl("lb_o1") as Label;
                        Label lb_o2 = DataList2.Items[i].FindControl("lb_o2") as Label;
                        Label lb_o3 = DataList2.Items[i].FindControl("lb_o3") as Label;
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            try
            {
                ...
                Label lb_mnum = e.Row.FindControl("lb_mnum") as Label;
                mtb.Visible = false;
    ...
    protected void DataList2_ItemDataBound(object sender, DataListItemEventArgs e)
    {
        ...
        try
        {
            ...
            Label lb_o1 = e.Item.FindControl("lb_o1") as Label;
            Label lb_o2 = e.Item.FindControl("lb_o2") as Label;
            Label lb_o3 = e.Item.FindControl("lb_o3") as Label;
            ...
            for (int i = 0; i < otdt.Rows.Count; i++)
            {
                ...
                {
                    lb_o1.Text += "<br>" + otdt[i].o1 + "<br>";
                    lb_o2.Text += "<br>" + otdt[i].o2 + "<br>";
                    lb_o3.Text += "<br>" + otdt[i].o3 + "<br>";
                }
                else
                {
                    lb_o1.Text += "" + otdt[i].o1 + "<br>";
                    lb_o2.Text += "<br>" + otdt[i].o2 + "<br>";
                    lb_o3.Text += "<br>" + otdt[i].o3 + "<br>";
                }
