<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EFF0111.aspx.cs" Inherits="HR_EFF0111" Title="合晶科技績效考核系統（Web版）v1.0" %>
    ...
    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="2">
        ...
        <asp:View ID="View3" runat="server">
            ...
            <asp:FormView ID="FormView1" runat="server" DataKeyNames="D_NO" DataSourceID="ObjectDataSource2" OnItemInserted="FormView1_ItemInserted" OnItemInserting="FormView1_ItemInserting" OnItemUpdated="FormView1_ItemUpdated" OnItemUpdating="FormView1_ItemUpdating">
                ...
                <ItemTemplate>
                    代碼:
                    <asp:Label ID="D_NOLabel" runat="server" Text='<%# Eval("D_NO") %>'></asp:Label><asp:Label ID="ADATELabel" runat="server" Text='<%# Eval("ADATE", "{0:yyyy/MM/dd}") %>'></asp:Label><br />
                    部門名稱:
                    <asp:Label ID="D_NAMELabel" runat="server" Text='<%# Bind("D_NAME") %>'></asp:Label>
            ...
            <asp:ObjectDataSource ID="CateObjectDataSource3" runat="server" DeleteMethod="Delete"
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="ddate" Type="DateTime" />
                        ...
                        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource3" PageSize="20">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="工作目標">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink1" runat="server" Target="_blank" NavigateUrl='<%#  "~/emp/EFF004.aspx?nobr=" + Eval("nobr") %>'>工作目標</asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="考核表">
                                 <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink11" runat="server" Target="_blank" NavigateUrl='<%#  "~/emp/EFF001.aspx?nobr=" + Eval("nobr") %>'>考核表</asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
