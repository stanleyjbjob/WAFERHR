...
public partial class qQuestionaryS : System.Web.UI.Page
{
    public QuestionaryDSTableAdapters.TRQGTableAdapter taTRQG = new QuestionaryDSTableAdapters.TRQGTableAdapter();
    ...
    protected void fv_ItemInserting(object sender, FormViewInsertEventArgs e)
    {
        ...
        {
            int i = 1;
            while (taTRQG.GetDataByTRQCODE(Code, i).Rows.Count > 0)
                i++;
