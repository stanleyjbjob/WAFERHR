...
public partial class tsTitleM : System.Web.UI.Page
{
    private TsDSTableAdapters.tsTitleMTableAdapter tsTitleMTA = new TsDSTableAdapters.tsTitleMTableAdapter();
    ...
    protected void fv_ItemInserting(object sender, FormViewInsertEventArgs e)
    {
        ...
        if (tsTitleMTA.GetDataByKey(e.Values["sCode"].ToString()).Rows.Count > 0 || e.Values["sCode"].ToString().Trim() == "0")
        {
            mp.Msg = "代碼重複";
            e.Cancel = true;
        }
