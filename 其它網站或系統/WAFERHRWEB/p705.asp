...
<%
	...
	If Len(mMANG_NOBR)=0 Then
		...
		'response.write "<b>請重新login</b><br><br>"
	...
	response.write "<tr><td width="&m34&"100%"&m34& _
						" colspan="&m34&"8"&m34& _
						" class="&m34&"form_title"&m34&">◆ 公 出 資 料 簽 核 ◆</td></tr>"
	...
	response.write "<td>主管姓名：" & Rs1.fields("NAME_C") & "</td>"
	...
	If not Rs2.eof Then
		response.write "<tr>"
	    response.write "<td colspan="&m34&"8"&m34&"><B>　未簽核之假單　　</B>" & _
	    		"<input type="&m34&"button"&m34& _
	    		" value="&m34&"　儲存核准　"&m34& _
	    		" name="&m34&"B1"&m34& _
	    		" onclick="&m34&"datacheck"&m34&"></td>"
	    response.write "</tr>"
		response.write "<tr>"
		response.write "<td width="&m34&"40"&m34&" class="&m34&"td2"&m34&">簽核</td>"
		response.write "<td width="&m34&"90"&m34&" class="&m34&"td2"&m34&">員工姓名</td>"
		response.write "<td width="&m34&"90"&m34&" class="&m34&"td2"&m34&">員工編號</td>"
		response.write "<td width="&m34&"90"&m34&" class="&m34&"td2"&m34&">請假日期</td>"
		...
		response.write "<td width="&m34&"35%"&m34&" class="&m34&"td2"&m34&">出差事由</td></tr>"
		Data_Count=0
...
<%
	If not Rs3.eof Then
		response.write "<tr>"
	    response.write "<td colspan="&m34&"8"&m34&"><B>　已簽核之假單</B></td>"
	    response.write "</tr>"
		response.write "<tr>"
		response.write "<td width="&m34&"40"&m34&" class="&m34&"td2"&m34&">簽核</td>"
		response.write "<td width="&m34&"90"&m34&" class="&m34&"td2"&m34&">員工姓名</td>"
