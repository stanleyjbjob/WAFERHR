...
SELECT id, name, PosLevel_id FROM tempPos WHERE (id = @id)";
    ...
    public partial class BASETTSTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT          RTRIM(BASE.NOBR) AS id, RTRIM(BASE.PASSWORD) AS pw, RTRIM(BASE.NAME_C) AS name, RTRIM(BASE.EMAIL) 
                            AS email, '' AS login, RTRIM(BASE.SEX) AS sex, RTRIM(BASETTS.DEPTM) AS dept, RTRIM(BASETTS.DEPTS) 
                            AS depts, RTRIM(BASETTS.JOB) AS job, RTRIM(BASETTS.JOBL) AS jobl, '' AS jobs, BASETTS.MANG
FROM              BASE INNER JOIN
                            BASETTS ON BASE.NOBR = BASETTS.NOBR
WHERE          (GETDATE() BETWEEN BASETTS.ADATE AND BASETTS.DDATE) AND (BASETTS.TTSCODE IN (1, 4, 6))";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
    ...
    public partial class DeptATableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT          RTRIM(D_NO) AS id, RTRIM(DEPT_GROUP) AS idParent, RTRIM(D_NAME) A" +
                "S name, \'0\' AS DeptLevel_id\r\nFROM              DEPTA";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
