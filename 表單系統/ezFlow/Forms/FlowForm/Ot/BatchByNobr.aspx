<%@ Page Title="" Language="C#" MasterPageFile="~/mpDialog20140102.master" AutoEventWireup="true" CodeFile="BatchByNobr.aspx.cs" Inherits="Ot_BatchByNobr" %>
        ...
        <tr>
            <td>
                <table class="auto-style1">
                    <tr>
                        <td>工號</td>
                         <td>                                <telerik:RadComboBox ID="txtNameAppS" runat="server" Culture="zh-TW" AllowCustomText="True"
                                ...
                                <asp:Label ID="lblNobrAppS" runat="server"></asp:Label></td>
                        <td>日期</td>
                        <td>
                           <table>
                                    <tr>
