<%@ Page Title="" Language="C#" MasterPageFile="~/mpCheck20140115.master" AutoEventWireup="true" CodeFile="Check.aspx.cs" Inherits="ShiftShort_Check" %>
                        ...
                        <MasterTableView AutoGenerateColumns="False" DataKeyNames="iAutoKey">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="dDateB" DataFormatString="{0:d}" DataType="System.DateTime"
                                    FilterControlAltText="Filter dDateB column" HeaderText="換班後日期" SortExpression="dDateB"
                                    UniqueName="dDateB">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="sRoteNameB" FilterControlAltText="Filter sRoteNameB column"
                                    HeaderText="換班後班別" SortExpression="sRoteNameB" UniqueName="sRoteNameB">
                                </telerik:GridBoundColumn>
