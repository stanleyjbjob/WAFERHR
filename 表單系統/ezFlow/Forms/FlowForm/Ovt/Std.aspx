<%@ Page Title="" Language="C#" MasterPageFile="~/mpStd1021202.master" AutoEventWireup="true" CodeFile="Std.aspx.cs" Inherits="Ovt_Std" %>
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="btnAdd">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="gvAppS" UpdatePanelCssClass="" />
            ...
            <telerik:AjaxSetting AjaxControlID="btnFlow">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="btnFlow" UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="gvAppS" UpdatePanelCssClass="" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        ...
        <table width="100%">
                    ...
                    <table width="100%">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <telerik:RadButton ID="btnDate" runat="server" CommandArgument="../MT/Calendar.aspx" CommandName="Calendar" OnClick="btnDate_Click" Text="重新載入" Visible="False">
                                            </telerik:RadButton>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <telerik:RadComboBox ID="ddlRote" runat="server" Culture="zh-TW" EnableVirtualScrolling="True" ItemsPerRequest="10" LoadingMessage="載入中…" Visible="False">
                                </telerik:RadComboBox>
                            </td>
                            <th nowrap="nowrap" width="1%">
                                <telerik:RadButton ID="btnTransCard" runat="server" CommandArgument="../MT/Calendar.aspx" CommandName="Calendar" OnClick="btnTransCard_Click" Text="轉換" Visible="False">
                                </telerik:RadButton>
                            </th>
                            <td>
                                <telerik:RadComboBox ID="ddlDepts" runat="server" Culture="zh-TW" EnableVirtualScrolling="True" ItemsPerRequest="10" LoadingMessage="載入中…" Visible="False">
                                </telerik:RadComboBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4" nowrap="nowrap" width="1%">
                                <telerik:RadButton ID="btnAdd" runat="server" Text="新增"               Font-Bold="True" Font-Size="XX-Large" ForeColor="Blue" Height="50px"                       OnClick="btnAdd_Click">
                                </telerik:RadButton>
            ...
            <tr>
                <td>
                    ...
                    <asp:FileUpload ID="fuExcel" runat="server" Visible="False" />
                    <asp:Button ID="btnUpload" runat="server" onclick="btnUpload_Click" Text="上傳後新增資料" Visible="False" />
                    <asp:HyperLink ID="hlExcel" runat="server" NavigateUrl="~/Upload/Ot.xls" Visible="False">範例檔下載</asp:HyperLink>
