...
public partial class Ovt_Check2 : System.Web.UI.Page
{
    ...
    protected void gvAppS_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        {
            Dialog(cn, "", "", "", ca, "", "rwCheckEdit");
        }
        else if (cn == "RebindGrid")
        {
            gvAppS.Rebind();
        }
    }

    private void Dialog(string Case, string NobrM = "", string NobrS = "", string ProcessID = "", string Key1 = "", string Key2 = "" , string WindowName = "rwMT")
    {
        string DialogPage = "";
        ...
        RadScriptManager.RegisterStartupScript(this.Page, typeof(UpdatePanel), "key", "window.radopen('" + DialogPage + "?Parm=" + DialogParm + "', '" + WindowName + "');", true);
    }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        //    if (rAppS.bSign)
        //    {
        //        if (!oAttcardDao.IsCardTime(rAppS.sNobr, rAppS.dDateE.Date, rAppS.sTimeB, rAppS.sTimeE))
        //        {
        //            RadWindowManager1.RadAlert(rAppS.sName + "所申請的時間不在刷卡時間裡", 300, 100, "警告訊息", "", "");
        //            return;
        //        }
        //    }
        //}
        ...
        {
            RadWindowManager1.RadAlert("簽核錯誤，請登出重新簽核", 300, 100, "警告訊息", "", ""); //刪除失敗 警告訊息
            return;
        }

        rAppM.sNote = txtNote.Text.ToHtml();
        ...
        if (rEmpM != null)
        {
            ...
            rSignM.sNote = txtNote.Text.ToHtml();
