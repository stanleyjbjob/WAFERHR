<%@ Page Title="" Language="C#" MasterPageFile="~/mpCheck20140115.master" AutoEventWireup="true" CodeFile="View.aspx.cs" Inherits="Ovt_View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="plAppS" runat="server" ToolTip="被申請人">
        <table width="100%">
            ...
            <tr>
                <td>
                    <telerik:RadGrid ID="gvAppS" runat="server" Culture="zh-TW" Width="100%" 
                        ...
                        <MasterTableView AutoGenerateColumns="False" DataKeyNames="iAutoKey">
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" UniqueName="TemplateColumn">
                                    <ItemTemplate>
                                        <telerik:RadButton ID="btnDelete" runat="server" CommandName="Del" Text="駁回" 
                                         Visible="false"    CommandArgument='<%# Eval("iAutoKey") %>' ToolTip='<%# Eval("sState") %>'>
                                        </telerik:RadButton>
                                    </ItemTemplate>
                                ...
                                <telerik:GridBoundColumn DataField="dDateB" DataFormatString="{0:d}" DataType="System.DateTime"
                                    FilterControlAltText="Filter dDateB column" HeaderText="實際日期" SortExpression="dDateB"
                                    UniqueName="dDateB">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridBoundColumn DataField="iTotalHour" FilterControlAltText="Filter iTotalHour column"
                                    HeaderText="實際時數" SortExpression="iTotalHour" UniqueName="iTotalHour">
                                </telerik:GridBoundColumn>
