<%@ Page Title="" Language="C#" MasterPageFile="~/mpCheck20140115.master" AutoEventWireup="true" CodeFile="Check.aspx.cs" Inherits="Card_Check" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="plAppS" runat="server" ToolTip="被申請人">
        <table width="100%">
            ...
            <tr>
                <td>※被駁回的資料將以整列<font color="red">紅色</font>表示；剩餘時數僅供參考。</td>
            </tr>
        </table>
