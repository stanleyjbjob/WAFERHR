<%@ Page Title="" Language="C#" MasterPageFile="~/mpCheck20140115.master" AutoEventWireup="true"
    CodeFile="Check.aspx.cs" Inherits="Abs_Check" ValidateRequest="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="plAppS" runat="server" ToolTip="被申請人">
        <table width="100%">
            ...
            <tr>
                <td>
                    <telerik:RadGrid ID="gvAppS" runat="server" CellSpacing="0" Culture="zh-TW" DataSourceID="sdsAppS"
                        GridLines="None" Width="100%" OnItemCommand="gvAppS_ItemCommand" 
                        onitemdatabound="gvAppS_ItemDataBound">
                        <AlternatingItemStyle HorizontalAlign="Center" />
                        <MasterTableView AutoGenerateColumns="False" DataKeyNames="iAutoKey" DataSourceID="sdsAppS">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="dDateB" DataType="System.DateTime" FilterControlAltText="Filter dDateB column"
                                    HeaderText="開始日期" SortExpression="dDateB" UniqueName="dDateB" DataFormatString="{0:d}">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridBoundColumn DataField="dDateE" FilterControlAltText="Filter dDateE column"
                                    HeaderText="結束日期" SortExpression="dDateE" UniqueName="dDateE" DataFormatString="{0:d}"
                                ...
                                <telerik:GridBoundColumn DataField="iUse" DataType="System.Decimal" 
                                    FilterControlAltText="Filter iTotalDay column" HeaderText="使用" 
                                    SortExpression="iUse" UniqueName="iUse">
                                </telerik:GridBoundColumn>
                                                                <telerik:GridBoundColumn DataField="iBalance" DataType="System.Decimal" 
                                    FilterControlAltText="Filter iTotalDay column" HeaderText="剩餘" 
                                    SortExpression="iBalance" UniqueName="iBalance">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridBoundColumn DataField="sNote" 
                                    FilterControlAltText="Filter sNote column" HeaderText="原因" 
                    ...
                    </telerik:RadGrid><asp:SqlDataSource ID="sdsAppS" runat="server" ConnectionString="<%$ ConnectionStrings:Flow %>"
