...
public class SaveAbsc : System.Web.Services.WebService
{
    ...
    public bool Run(int ID)
    {
        ...
        string sSubject = "【通知】(" + rAppM.sNobr + ")" + rAppM.sName + " 之銷假單";
        string sBody = "";
        ...
        foreach (var rAppS in rsAppS)
        {
            if (rAppS.bSign)
            {
                bool bPass = oAbsDao.AbsDelete(rAppS.sNobr, rAppS.dDate, rAppS.sTimeB, rAppS.sHcode, rAppM.sName, rAppM.sProcessID);
                rAppS.sState = "3";
            }
