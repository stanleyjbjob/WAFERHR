...
/// <summary>
/// SaveShiftShort 的摘要描述
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// 若要允許使用 ASP.NET AJAX 從指令碼呼叫此 Web 服務，請取消註解下列一行。
// [System.Web.Script.Services.ScriptService]
public class SaveShiftShort : System.Web.Services.WebService {

    public SaveShiftShort () {
    ...
    public bool Run(int ID)
    {
        ...
        string sSubject = "【通知】(" + rAppM.sNobr + ")" + rAppM.sName + " 之換班單";
        string sBody = "";
        ...
        foreach (var rAppS in rsAppS)
        {
            if (rAppS.bSign)
            {
                bool bPass = oRotechgDao.Save(rAppS.sNobrA, rAppS.dDateA, rAppS.sRoteB, "", rAppM.sName, rAppM.sProcessID);
                bPass = oRotechgDao.Save(rAppS.sNobrA, rAppS.dDateB, rAppS.sRoteA, "", rAppM.sName, rAppM.sProcessID);
                rAppS.sState = "3";
            }

            sBody += ("<font size='5' color='red'>此筆資料" + (rAppS.sState == "3" ? "核准" : "駁回")) + rAppS.sMailBody + "</font><BR><BR>";
