...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <div>
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
            ...
            <tr>
                <td>
                    ...
                    <asp:SqlDataSource ID="sdsSignState" runat="server" ConnectionString="<%$ ConnectionStrings:flow %>"
                        SelectCommand="SELECT * FROM wfAbsAppS &#13;&#10;WHERE         (sNobr = @sNobr) AND (idProcess <> 0) AND (@sState = 'a' OR sState = @sState)">
                        <SelectParameters>
            ...
            <tr>
                <td>
                    被申請人工號：<asp:Label ID="lblNobr" runat="server" Text="000000"></asp:Label>
                    <asp:DropDownList ID="ddlName" runat="server" AutoPostBack="True" DataSourceID="sdsName"
                        DataTextField="name" DataValueField="Emp_id" OnDataBound="ddlName_DataBound"
