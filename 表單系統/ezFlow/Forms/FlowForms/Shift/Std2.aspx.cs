...
public partial class Shift_Std2 : System.Web.UI.Page
{
    //HR
    ...
    public void SetDefault() {
        ...
        ddlRotet.DataBind();
        ddlRotetB.DataBind();
        ddlHolidayNew.DataBind();
        ddlHolidayOld.DataBind();
    ...
    public void SetSelect() {
        try {
            ...
            ddlHolidayOld.Items.FindByValue(SetHoliday(lblNobr.Text)).Selected = true;

            ddlRotet.ClearSelection();
            ddlRotetB.ClearSelection();
            ddlHolidayNew.ClearSelection();
    ...
    //設定行事曆 20080213 by ming
    public string SetHoliday(string nobr)
    {
        string holiday = "";
        BaseDataTA.FillByNobr(oHrDS.BaseData, nobr);
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        rs.sHolidayCode = ddlHolidayNew.SelectedItem.Value;
        rs.sHolidayName = ddlHolidayNew.SelectedItem.Text;
        rs.sReserve1 = (ddlHolidayNew.SelectedItem.Value == "000") ? ddlHolidayOld.SelectedItem.Value : ddlHolidayNew.SelectedItem.Value;    //行事曆 20080213 by ming
        rs.bSign = true;
        rs.sState = "0";
        rs.bAuth = true;
