<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Std1.aspx.cs" Inherits="Shift_Std1" %>
        ...
        <asp:UpdatePanel ID="upl" runat="server">
            <ContentTemplate>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <table border="0" style="width: 100%" class="WebPanel2ctl" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td align="center" style="text-align: left">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td class="UltraWebGrid1-hc" colspan="6" nowrap="nowrap" width="1%" style="font-size: 12pt; color: blue">
                                                    <strong>
                                                    新增換班人員</strong></td>
                                            </tr>
                                            <tr>
                                                <td nowrap="nowrap" class="UltraWebGrid1-hc" width="1%">
                                                    &nbsp;</td>
                                                ...
                                                <td nowrap="nowrap" align="center" class="UltraWebGrid1-hc">
                                                    班別</td>
                                                <td nowrap="nowrap" rowspan="4" class="UltraWebGrid1-ic" width="1%">
                                                    <asp:Button ID="btnAdd" runat="server" Font-Bold="True" Font-Size="XX-Large"
                                                        Text="新增" OnClick="btnAdd_Click" ForeColor="Blue" CssClass="UltraWebGrid1-hc" /></td>
                                            </tr>
                                            <tr>
                                                <td nowrap="nowrap" align="right" class="UltraWebGrid1-ic" width="1%">
                                                    原班別(A)</td>
                                                <td nowrap="nowrap" align="center" class="UltraWebGrid1-ic">
                                                ...
                                                <td nowrap="nowrap" align="center" class="UltraWebGrid1-ic">
                                                    <asp:DropDownList ID="ddlName" runat="server" AutoPostBack="True" DataSourceID="sdsName" DataTextField="name" DataValueField="Emp_id" OnSelectedIndexChanged="ddlName_SelectedIndexChanged">
                                                        ...
                                                        Width="50px" OnTextChanged="txtName_TextChanged" CssClass="txtBoxLine"></asp:TextBox>
                                                </td>
                                                <td nowrap="nowrap" align="center" class="UltraWebGrid1-ic">
                                                    <asp:TextBox ID="txtAuthority" runat="server" Width="55px" AutoPostBack="True" OnTextChanged="txtAuthority_TextChanged" CssClass="txtBoxLine"></asp:TextBox></td>
                                                <td nowrap="nowrap" align="center" class="UltraWebGrid1-ic">
                                                ...
                                                <td nowrap="nowrap" align="center" class="UltraWebGrid1-ic">
                                                    <div>
                                                        <asp:DropDownList ID="ddlNameB" runat="server" AutoPostBack="True" DataSourceID="sdsName" DataTextField="name" DataValueField="Emp_id" OnSelectedIndexChanged="ddlName_SelectedIndexChanged">
                                                            ...
                                                            Width="50px" OnTextChanged="txtName_TextChanged" CssClass="txtBoxLine"></asp:TextBox></div>
                                                </td>
                                                <td nowrap="nowrap" align="center" class="UltraWebGrid1-ic">
                                                    <asp:TextBox ID="txtAim" runat="server" Width="55px" AutoPostBack="True" OnTextChanged="txtAuthority_TextChanged" CssClass="txtBoxLine"></asp:TextBox></td>
                                                <td nowrap="nowrap" align="center" class="UltraWebGrid1-ic">
                                            ...
                                            <tr>
                                                <td nowrap="nowrap" style="text-align: right" class="UltraWebGrid1-ic" width="1%">
                                                    事由</td>
                                                <td nowrap="nowrap" colspan="4" class="UltraWebGrid1-ic">
                                                    <asp:TextBox ID="txtNote" runat="server" Width="95%" CssClass="txtBoxLine"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="UltraWebGrid1-ic" colspan="6" nowrap="nowrap" rowspan="1">
                                        ...
                                        <asp:SqlDataSource ID="sdsRotet" runat="server" ConnectionString="<%$ ConnectionStrings:hr %>"
                                            SelectCommand="SELECT RTRIM(ROTET) AS ROTET, RTRIM(ROTETNAME) + '(' + RTRIM(ROTET) + ')' AS ROTETNAME FROM ROTET">
                                                    ...
                                                    <asp:DropDownList ID="ddlRoteCate" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlRoteCate_SelectedIndexChanged" Visible="False">
                                                        <asp:ListItem Value="1" Selected="True">短期調班單</asp:ListItem>
                                ...
                                <tr>
                                    <td align="center" style="text-align: left">
                                        <table border="0" style="width: 100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="font-size: 12pt; color: blue;" class="UltraWebGrid1-hc">
                                                    <strong>
                                                    換班人員基本資料</strong></td>
                                            </tr>
                                            <tr>
                                                <td>
                                        <asp:GridView ID="gvAppS" runat="server" Width="100%" AutoGenerateColumns="False" DataSourceID="sdsAppS" CellPadding="4" ForeColor="#333333" GridLines="None" AllowSorting="True" DataKeyNames="iAutoKey">
                                            <Columns>
                    ...
                    <tr>
                        <td nowrap="nowrap">
                            <asp:Button ID="btnSign" runat="server" Text="送出傳簽" Font-Bold="True" Font-Size="XX-Large" ForeColor="Blue" OnClick="btnSign_Click" OnClientClick="return confirm('您確定要送出傳簽嗎？');" Font-Underline="False" CssClass="UltraWebGrid1-hc" />
