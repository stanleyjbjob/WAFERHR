<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Check.aspx.cs" Inherits="Shift_Check" %>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td align="center" nowrap="nowrap">
                                <table border="0" style="width: 100%" class="WebPanel2ctl">
                                    <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <asp:SqlDataSource ID="sdsAppS" runat="server" ConnectionString="<%$ ConnectionStrings:flow %>"
                                                            DeleteCommand="DELETE FROM [wfShiftAppS] WHERE [iAutoKey] = @iAutoKey" SelectCommand="SELECT iAutoKey, sProcessID, idProcess, sRoteCate, sRoteCateName, sNobr, sName, sDept, sDeptName, sJob, sJobName, sJobl, sJoblName, sEmpcd, sEmpcdName, sRote, sRoteName, dAuthority, sNobrB, sNameB, sDeptB, sDeptNameB, sRoteB, sRoteNameB, dAim, bSign, sState, bAuth, sNote, dKeyDate FROM wfShiftAppS WHERE (sProcessID = @sProcessID)">
                                                            <DeleteParameters>
