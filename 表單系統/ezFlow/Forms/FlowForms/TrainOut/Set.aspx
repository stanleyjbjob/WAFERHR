<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Set.aspx.cs" Inherits="TrainOut_Set"  validateRequest="false"%>
<%@ Register Assembly="FredCK.FCKeditorV2" Namespace="FredCK.FCKeditorV2" TagPrefix="FCKeditorV2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>外訓申請單---設定</title>
            ...
            <ContentTemplate>
                <asp:FormView ID="fvSet" runat="server" DataKeyNames="iAutoKey" DataSourceID="sdsSet" DefaultMode="Edit" OnItemUpdating="fvSet_ItemUpdating" Width="100%">
                    <EditItemTemplate>
                        ...
                        <asp:CheckBox ID="bUploadFileCheckBox" runat="server" Checked='<%# Bind("bUploadFile") %>' Text="可上傳附件" /></td>
                            </tr>
                            <tr>
                                <td class="UltraWebGrid1-hc" nowrap="nowrap" style="text-align: right" width="1%">
                                    最大申請筆數</td>
                ...
                <asp:SqlDataSource ID="sdsSet" runat="server" ConnectionString="<%$ ConnectionStrings:flow %>"
                    SelectCommand="SELECT * FROM [wfTrainSet]" UpdateCommand="UPDATE wfTrainSet SET sStdNote = @sStdNote, sCheckNote = @sCheckNote, bAgentApp = @bAgentApp, bSignNote = @bSignNote, bSignState = @bSignState, bUploadFile = @bUploadFile, iAppCount = @iAppCount, iDelay = @iDelay, sKeyMan = @sKeyMan, dKeyDate = @dKeyDate WHERE (iAutoKey = @iAutoKey)">
                    <UpdateParameters>
