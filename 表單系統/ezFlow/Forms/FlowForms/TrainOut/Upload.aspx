<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Upload.aspx.cs" Inherits="TrainOut_Upload" %>
            ...
            <tr>
                <td nowrap="nowrap">
                    ...
                    <asp:SqlDataSource ID="sdsUpload" runat="server" ConnectionString="<%$ ConnectionStrings:flow %>"
                        DeleteCommand="DELETE FROM [wfUpFile] WHERE [iAutoKey] = @iAutoKey" SelectCommand="SELECT iAutoKey, sFromCode, sFromName, sProcessID, idProcess, sNobr, sUpName, sServerName, sDesc, sType, iSize, dUpDate FROM wfUpFile WHERE (sProcessID = @sProcessID)">
                        <DeleteParameters>
