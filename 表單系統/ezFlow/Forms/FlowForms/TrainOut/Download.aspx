<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Download.aspx.cs" Inherits="TrainOut_Download" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>外訓單---檔案下載</title>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 100%">
            ...
            <tr>
                <td nowrap="nowrap">
                    ...
                    <asp:SqlDataSource ID="sdsUpload" runat="server" ConnectionString="<%$ ConnectionStrings:flow %>" SelectCommand="SELECT * FROM [wfUpFile] WHERE ([sProcessID] = @sProcessID) ">
                        <SelectParameters>
