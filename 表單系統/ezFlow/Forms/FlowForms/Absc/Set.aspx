<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Set.aspx.cs" Inherits="Absc_Set" validateRequest="false"%>
        ...
        <asp:UpdatePanel ID="upl" runat="server">
            <ContentTemplate>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="WebPanel2ctl" width="100%">
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <asp:CheckBox ID="CheckBox3" runat="server" Checked='<%# Bind("bAgentApp") %>' Text="可代理申請" />
                ...
                <asp:SqlDataSource ID="sdsSet" runat="server" ConnectionString="<%$ ConnectionStrings:flow %>"
                    SelectCommand="SELECT * FROM [wfAbscSet]" UpdateCommand="UPDATE [wfAbscSet] SET [sStdNote] = @sStdNote, [sCheckNote] = @sCheckNote, [bAgentApp] = @bAgentApp, [bSignNote] = @bSignNote, [bSignState] = @bSignState, [bNote] = @bNote, [iAppCount] = @iAppCount, [iDelay] = @iDelay, [sKeyMan] = @sKeyMan, [dKeyDate] = @dKeyDate WHERE [iAutoKey] = @iAutoKey">
                    <UpdateParameters>
