<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Check.aspx.cs" Inherits="Absc_Check" %>
                            ...
                            <table border="0" class="WebPanel2ctl" style="width: 100%">
                                ...
                                <tr>
                                    <td align="center" style="text-align: left">
                                        ...
                                        <asp:SqlDataSource ID="sdsAppS" runat="server" ConnectionString="<%$ ConnectionStrings:flow %>" SelectCommand="SELECT * FROM [wfAbscAppS] WHERE ([sProcessID] = @sProcessID)">
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="lblProcessID" Name="sProcessID" PropertyName="Text"
                                                    Type="String" />
                                            </SelectParameters>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <asp:SqlDataSource ID="sdsSign" runat="server" ConnectionString="<%$ ConnectionStrings:flow %>"
                                                            DeleteCommand="DELETE FROM [wfShiftAppS] WHERE [iAutoKey] = @iAutoKey" SelectCommand="SELECT iAutoKey, sFromCode, sFromName, sProcessID, idProcess, sNobr, sName, sDept, sDeptName, sNote, bSign, sSign, dKeyDate FROM wfSign WHERE (sProcessID = @sProcessID) AND (sFromCode = 'Absc')">
                                                            <DeleteParameters>
